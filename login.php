...
<body>
    ...
    <script>
        document.getElementById('formLogin').addEventListener('submit', function(e) {
            ...
            // 1. Ambil teks yang diketik oleh user di dalam form
            ...
            if (username === "" || password === "") { 
                ...
                // KONDISI C: Jika username benar, tapi password SALAH
                Swal.fire({
                    icon: "error",
                    title: "Login Gagal...",
                ...
                // KONDISI D: Jika username "admin" dan password "12345" (SUKSES)
                Swal.fire({
                    icon: "success",
                    title: "Berhasil!",
                    text: "Selamat datang kembali di FloraMeans.",
                    showConfirmButton: false,
                    timer: 1500 // Alert hilang otomatis dalam 1.5 detik
                });
            }
        });
